...
export interface objectdecorator_playermovement_t extends objectdecorator_t {
  enable: boolean
}
...
const make_decorator = (decorated_machine:objectmachine_t, enable:boolean) => {
  ...
  const me:objectdecorator_playermovement_t = <objectdecorator_playermovement_t>obj;
